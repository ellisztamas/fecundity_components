...
vs
23.4).
Selection through seed number per fruit in Sweden in 2010 is a novel source of selection as none was previously detected for survival or fruits/RP (figure \ref{fig:selection-correlations}B; Ågren \& Schemske 2012). The only significant source of selection in 2011 in Sweden was via survival (figure \ref{fig:selection-correlations}B; Ågren \emph{et al.} 2013).
