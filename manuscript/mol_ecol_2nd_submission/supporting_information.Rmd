...
**Tables:**
  ...
  1. Individual QTL for seeds/fruit
  2. Epistatic interactions
  3. Individual QTL for fruits/seedling
  4. Individual QTL for seeds/seedling
  5. Individual QTL for seed mass
  6. Individual QTL for survival
  7. Individual QTL for fruits/RP
  8. Individual QTL for seeds/RP

**Figures:**

  1. Epistatic interactions for seeds/fruit
  2. Seed mass differences between parental lines
  3. Epistatic interactions for seed mass
  4. Scatter plots of RIL-means for fecundity and survival, components of fecundity, and fecundity and seed mass
  5. Epistatic interactions for fruits/RP
  6. Broad-sense heritability estimates
  7. Epistatic interactions for seeds/RP
  8. Epistatic interactions for seeds/seedling
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],#, "PDE")],
      ...
      caption="QTL for seeds/fruit identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects and as a percentage of variance among RIL means.")
```
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],# "PDE")],
      ...
      digits = c(0,0,0,0,0,1,3,1,1),
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption = "QTL for fruits/seedling identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects, as a percentage of variance among RIL means, and as a percentage of the difference between parental means.")
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],#, "PDE")],
      ...
      digits = c(0,0,0,0,0,1,3,1,1),
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption = "QTL for seeds/seedling identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects and as a percentage of variance among RIL means.")
...
kable(d,#tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],#, "PDE")],
      ...
      digits = c(0,0,0,0,0,1,3,1,1),
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption="QTL for seed mass identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects and as a percentage of variance among RIL means.")
```
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],# "PDE")],
      ...
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption = "QTL for survival to reproduction identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects, as a percentage of variance among RIL means, and as a percentage of the difference between parental means.")
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],#, "PDE")],
      ...
      digits = c(0,0,0,0,0,1,3,1,1),
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption="QTL for fruits/RP identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects and as a percentage of variance among RIL means.")
```
...
kable(tab[,c("name", "site", "year","chr","position","LOD", "effect_sizes","PVE")],#, "PDE")],
      ...
      digits = c(0,0,0,0,0,1,3,1,1),
      col.names = c("Name", "Site", "Year","Chr.","Position (cM)","LOD", "Effect size","% var. explained"),# "% diff. explained"),
      caption = "QTL for seeds/RP identifed in individual experiments. QTL positions are shown with their 95% Bayesian credible intervals. Effect sizes are given as additive effects and as a percentage of variance among RIL means.")
...
```{r fig: epistatic-mass, fig.width=9/2.54, fig.height=10/2.54, cache=T, cache.lazy=T, fig.cap="Interaction plots for epistatic interactions detected for seed mass, showing mean and standard errors for each genotype-by-genotype combination.", fig.scap = "Epistatic interactions for seed mass", fig.align='center', eval=T}
# seed mass
effectplot(
  cross$mass,
  pheno.col = "sw2011",
...
legend('bottomright', c("QTL 5@78.2", "It. allele", "Sw. allele"), col = c(0,2,4), pch=1, bty="n", cex=0.8)
...
```{r fig:epistatic-frut, eval = T, fig.width = 16.9 / 2.54, fig.height = 10 /2.54, cache = T, cache.lazy = T, fig.cap = "Interaction plots for epistatic interactions detected for fruits/RP, showing mean and standard errors for each genotype-by-genotype combination.", fig.scap = "Epistatic interactions for number of fruits per reproductive plant", fig.align='center', eval=T}
...
```{r fig:epistatic-tofu, eval = T, fig.width = 16.9 / 2.54, fig.height = 10 /2.54, cache = T, cache.lazy = T, fig.cap = "Interaction plots for epistatic interactions detected for seeds/RP, showing mean and standard errors for each genotype-by-genotype combination.", fig.scap = "Epistatic interactions for seeds/RP", fig.align='center', eval=T}
# number of seeds per plant
par(mfrow = c(1, 2))
