...
nor in Italy in either year
 ($|r| \leq$ `r round(max(correlations$obs[correlations$traits  == "tofu_vs_mass" & correlations$expt %in% c("it2010", "it2011")]), 2)`;
