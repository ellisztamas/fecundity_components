...
# }
for(i in 1:4){
  plotQTL_qtl(chr123, frut_stepwise[[i]], frut_fit[[i]], fill_cutoff = 15.2, lane = i+8 , col=colvec[i])
  plotQTL_qtl(chr123, seed_stepwise[[i]], seed_fit[[i]], fill_cutoff = 15.2, lane = i+12, col=colvec[i])
  plotQTL_qtl(chr123, tofu_stepwise[[i]], tofu_fit[[i]], fill_cutoff = 15.2, lane = i+16, col=colvec[i])
  plotQTL_qtl(chr123, mass_stepwise[[i]], mass_fit[[i]], fill_cutoff = 15.2, lane = i,    col=colvec[i])
  if(i != 3){ # no QTL for survival in 2010 in Sweden
  plotQTL_qtl(chr123, surv_stepwise[[i]], surv_fit[[i]], fill_cutoff = 15.2, lane = i+4,  col=colvec[i])
  }
}
...
for(i in 1:4){
  plotQTL_qtl(chr45, frut_stepwise[[i]], frut_fit[[i]], fill_cutoff = 15.2, lane = i+8,  col=colvec[i])
  plotQTL_qtl(chr45, seed_stepwise[[i]], seed_fit[[i]], fill_cutoff = 15.2, lane = i+12, col=colvec[i])
  plotQTL_qtl(chr45, tofu_stepwise[[i]], tofu_fit[[i]], fill_cutoff = 15.2, lane = i+16, col=colvec[i])
  plotQTL_qtl(chr45, mass_stepwise[[i]], mass_fit[[i]], fill_cutoff = 15.2, lane = i,    col=colvec[i])
  if(i != 3){ # no QTL for survival in 2010 in Sweden
  plotQTL_qtl(chr45, surv_stepwise[[i]], surv_fit[[i]], fill_cutoff = 15.2, lane = i+4,  col=colvec[i])
  }
}
# label pleiotropic regions
