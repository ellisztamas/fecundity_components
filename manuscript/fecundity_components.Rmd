...
We considered QTL identified for different sites, years or traits to map to the same region of the genome (colocalise) and represent the same QTL if the maximum-likelihood estimate of their positions were within 2 cM of each other, or if the 95% Bayesian credible intervals for these estimates overlapped. We excluded ’poorly-defined’ QTL whose credible intervals for QTL position were greater than one quarter of the length of the shortest chromosome (15.2cM) from assessments of colocalisation, because such QTL provide little information about position [@agren_genetic_2013; @dittmar2014flowering; @oakley2014qtl; @agren_flowering_time; @postma2018among]. Based on these criteria, we identified distinct pleiotropic QTL as those associated with two or more traits over the two years at a given site. We focussed on pleiotropic effects on the pairs of traits also considered in the analysis of genetic correlations among traits.
...
At the Swedish site, contributions of survival and the two components of fecundity to the overall advantage of the local genotype varied among year.
...
We detected twelve QTL for number of seeds per seedling planted in Italy (fig. \@ref(fig:fitness-qtl); supplementary table 3), two of which did not overlap with regions associated with QTL for number of fruits per seedling planted identified in a previous analysis (chromosome 2, 45.6cM in 2011; chromosome 4, 20.7cM in 2010; @agren_genetic_2013). In Sweden, we detected seven QTL for number of seeds per seedling planted, three of which did not overlap with QTL for number of fruits per seedling (chromosome 1, 22.7cM in 2010; chromosome 3, 18.0cM in 2011, and chromosome 4, 41-42cM in both years). These QTL for overall fitness were thus detected only when information about number of seeds per fruit was included in the estimate of fitness.
...
We found distinct regions of the linkage map with pleiotropic effects on survival and components of fecundity.
In all but two cases, well-defined QTL for number of number of fruits per reproductive plant, number of seeds per fruit and survival mapped to one of 13 distinct regions across the linkage map (Q1-Q13; fig. \@ref(fig:qtl-pleiotropy)).
Four of these regions in Italy (Q1, Q3, Q11, Q12) and six regions in Sweden (Q3, Q4, Q5, Q11, Q12, Q13) included QTL for both components of fecundity.
Meanwhile, four regions in Italy (Q3, Q4, Q7,Q13) and one region in Sweden (Q13) included QTL for both number of seeds per reproductive plant and survival.
In Italy, one QTL for survival (chr. 1, 40.6cM) and one QTL for number of seeds per fruit (chr. 2, 39.8cM) did not show significant pleiotropic effects on other traits.

With one exception, alleles at QTL within pleiotropic regions affected components of fitness in the same direction (fig. \@ref(fig:qtl-pleiotropy)).
In Italy, in all regions where well-defined QTL were detected for both number of fruits per reproductive plant and number of seeds per fruit (Q1, Q3, Q11, Q12) or for both number of seeds per reproductive plant and survival (Q3, Q4, Q5, Q11, Q12, Q13) the non-local Swedish alleles were associated with a decrease in both fitness components.
In Sweden, the local alleles at QTL in (Q13) were associated with an increase in both number of fruits per reproductive plant and number of seeds per fruit, whereas local alleles at QTL in regions Q3 and Q7 were associated with a decrease in both fitness components.
By contrast, the Swedish alleles at QTL in region Q4 were associated with a decrease in number of fruits per plant, but with an increase in number of seeds per fruit.
The local alleles at QTL in region Q13 were associated with an increase in both number of seeds per reproductive plant and survival.

QTL for seed mass showed both positive and negative pleiotropic effects with fecundity (fig. \@ref(fig:qtl-pleiotropy)). All well-defined QTL for seed mass mapped to regions with pleiotropic effects on survival and/or fecundity (Q1, Q8 and Q11 in Italy; Q1, Q2, Q5, Q11 in Sweden), except for the QTL on chromosome 4 (9.3cM) in Italy in 2011. In Italy, the Swedish alleles at QTL in region Q8 were associated with a decrease in both seed mass and number of seeds per reproductive plant. In contrast, Swedish alleles at QTL in regions Q1 and Q11 were associated with an increase in seed mass but a decrease in number of seeds per reproductive plant. In Sweden, QTL in only region Q2 had pleiotropic effects on seed mass and fecundity, where the local allele was associated with a decrease in seed mass, but an increase in number of seeds per reproductive plant.

### Epistasis

We observed four pairs of loci that showed significant epistatic interactions (supplementary table 5). Firstly, we detected an interaction for number of seeds per fruit between QTL in regions Q1 and Q11 in Italy in 2011, for which recombinant genotypes showed reduced seed number (supporting figure 1). We also found significant interactions for loci in the Q3 and Q7 QTL regions for number of seeds per fruit, number of seeds per reproductive plant and number of seeds per planted seeding in Sweden in 2011 (supporting figures 1-3). This corresponds to the pair of epistatic loci detected for number of fruits per reproductive plant in the previous analysis by @agren_genetic_2013. For all traits for which this interaction was detected, recombinant genotypes showed increased fecundity.

# Discussion

The present study demonstrates that genetic differences influencing number of seeds per fruit can make an important contribute to adaptive differentiation and the genetic basis of fitness variation among natural populations of *Arabidopsis thaliana*. In a reciprocal transplant between an Italian population located close to the southern margin of the European native range and a Swedish population located close to the northern range margin, the local genotype produced more seeds per fruit than did the non-local genotype in three of four site × year combinations. Including information about number of seeds per fruit thus increased the apparent overall fitness advantage of the local genotype compared to fitness estimates based on fruit production and survival alone. Genetic correlations between components of fecundity (number of fruits per reproductive plant and number of seeds per fruit), and between fecundity and survival were generally positive, whereas the correlation between fecundity and seed size was significant (and negative) in only one of four site × year combinations. The genetic correlations were reflected in widespread pleiotropic effects of QTL for fecundity and survival, with allelic effects typically in the same directions. Below we discuss the results in relation to their implications for adaptive differentiation and local adaptation.

## Adaptive differentiation through seed number variation

The examination of variation in number of seeds per fruit provided several new insights into the adaptive differentiation between the two study populations. In Italy, the local genotype produced more seeds per fruit in both years, and had a greater overall fitness advantage when fitness was estimated including information about number of seeds per fruit (fig. \@ref(fig:selection)). In Sweden in 2010, number of seeds per fruit was the only fitness component for which the parental genotypes differed. Including information on number of seeds per fruit in estimates of overall fitness indicated a significant advantage to the local genotype that was not detected using an estimate of overall fitness based on survival and number of fruits per reproductive plant only. Differences in number of seeds per fruit can thus make an important contribution to estimates of fitness differences among populations.
