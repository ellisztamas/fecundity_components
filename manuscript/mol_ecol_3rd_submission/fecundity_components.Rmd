...
kable(pairwise_pleiotropy$it, "latex", escape = F, 
      caption = "Number QTL detected for each trait, and the number of colocalising QTL detected for pairs of traits in 2010 (below the diagonal) and 2011 (above the diagonal) in Italy") %>% 
...
kable(pairwise_pleiotropy$sw, "latex", escape = F, 
      caption = "Number QTL detected for each trait, and the number of colocalising QTL detected for pairs of traits in 2010 (below the diagonal) and 2011 (above the diagonal) in 2011.") %>% 
  # kable_styling(bootstrap_options = "striped", full_width = F) %>%
  # map(~ spec(0, angle=90))
  row_spec(0, angle = 90)
```
